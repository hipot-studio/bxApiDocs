...
{
	/**
	 * Событие "BeforePostingSendMail" вызывается перед отправкой выпуска из метода <a
	 * href="http://dev.1c-bitrix.ru/api_help/subscribe/classes/cpostinggeneral/cpostingsendmessage.php">CPosting::SendMessage</a>.
	 *
	 *
	 ...
	 * &lt;?<br>// файл /bitrix/php_interface/init.php<br>// регистрируем обработчик<br>AddEventHandler("subscribe", "<b>BeforePostingSendMail</b>",
	 *     Array("MyClass", "BeforePostingSendMailHandler"));<br> class MyClass
	 * {
