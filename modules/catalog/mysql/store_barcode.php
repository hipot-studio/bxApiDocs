...
class store_barcode extends CAllCatalogStoreBarCode
{
    ...
    public static function getList($arOrder = [], $arFilter = [], $arGroupBy = false, $arNavStartParams = false, $arSelectFields = [])
    {
        ...
        if (empty($arSelectFields)) {
            $arSelectFields = ['ID', 'PRODUCT_ID', 'STORE_ID', 'BARCODE', 'ORDER_ID'];
        }

        $arFields = [
            'ID' => ['FIELD' => 'CB.ID', 'TYPE' => 'int'],
            'PRODUCT_ID' => ['FIELD' => 'CB.PRODUCT_ID', 'TYPE' => 'int'],
            'STORE_ID' => ['FIELD' => 'CB.STORE_ID', 'TYPE' => 'int'],
            'BARCODE' => ['FIELD' => 'CB.BARCODE', 'TYPE' => 'string'],
            'ORDER_ID' => ['FIELD' => 'CB.ORDER_ID', 'TYPE' => 'int'],
        ];
