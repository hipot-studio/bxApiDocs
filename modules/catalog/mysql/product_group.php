...
class product_group extends CAllCatalogProductGroups
{
    ...
    public static function GetList($arOrder = [], $arFilter = [], $arGroupBy = false, $arNavStartParams = false, $arSelectFields = [])
    {
        ...
        $arFields = [
            'ID' => ['FIELD' => 'CPG.ID', 'TYPE' => 'int'],
            'PRODUCT_ID' => ['FIELD' => 'CPG.PRODUCT_ID', 'TYPE' => 'int'],
            'GROUP_ID' => ['FIELD' => 'CPG.GROUP_ID', 'TYPE' => 'int'],
            'ACCESS_LENGTH' => ['FIELD' => 'CPG.ACCESS_LENGTH', 'TYPE' => 'int'],
            'ACCESS_LENGTH_TYPE' => ['FIELD' => 'CPG.ACCESS_LENGTH_TYPE', 'TYPE' => 'char'],
            'GROUP_ACTIVE' => ['FIELD' => 'G.ACTIVE', 'TYPE' => 'char', 'FROM' => 'INNER JOIN b_group G ON (CPG.GROUP_ID = G.ID)'],
            'GROUP_NAME' => ['FIELD' => 'G.NAME', 'TYPE' => 'string', 'FROM' => 'INNER JOIN b_group G ON (CPG.GROUP_ID = G.ID)'],
        ];
