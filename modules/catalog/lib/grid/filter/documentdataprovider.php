...
class documentdataprovider extends EntityDataProvider
{
    ...
    public function __construct($mode)
    {
        ...
        self::$fields = [
            ...
            'DOC_NUMBER' => [
                ...
                'default' => \CatalogStoreDocumentListComponent::ARRIVAL_MODE === $this->mode,
                'sort' => 'DOC_NUMBER',
            ],
            'DOC_TYPE' => [
                'id' => 'DOC_TYPE',
    ...
    public function prepareFields()
    {
        ...
        if (\CatalogStoreDocumentListComponent::OTHER_MODE !== $this->mode) {
            $fields['DOC_NUMBER'] = $this->createField('DOC_NUMBER');

            if (\CatalogStoreDocumentListComponent::MOVING_MODE === $this->mode) {
        ...
        if (\CatalogStoreDocumentListComponent::ARRIVAL_MODE === $this->mode) {
