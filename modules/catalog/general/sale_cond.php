...
class CCatalogCondCtrlCatalogSettings extends CGlobalCondCtrlComplex
{
    ...
    public static function GetControlShow($arParams)
    {
        ...
        foreach ($controlList as &$control) {
            ...
            if ('CondCatalogRenewal' === $control['ID']) {
                $jsControl['control'] = [
                    [
                        'id' => 'prefix',
                        'type' => 'prefix',
    ...
    public static function GetConditionShow($arParams)
    {
        ...
        if ('CondCatalogRenewal' === $arParams['ID']) {
    ...
    public static function Parse($arOneCondition)
    {
        ...
        if ('CondCatalogRenewal' === $arOneCondition['controlId']) {
    ...
    public static function Generate($arOneCondition, $arParams, $arControl, $arSubs = false)
    {
        ...
        if (!$boolError && 'Y' === $arOneCondition['value']) {
    ...
    public static function GetShowIn($arControls)
    {
        return [CSaleCondCtrlGroup::GetControlID()];
    }
    ...
    public static function GetControls($strControlID = false)
    {
        ...
        if (isset($controlList[$strControlID])) {
