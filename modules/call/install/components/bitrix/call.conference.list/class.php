...
//		{
			...
			<div class='im-conference-list-controls-buttons'>
				<button class='im-conference-list-controls-button-start ui-btn ui-btn-sm ui-btn-primary ui-btn-icon-start' data-conference-link='{$publicLink}'>{$startTitle}</button>
