...
use Bitrix\Crm\Integration\Intranet\CustomSection\Assembler;
...
class IntranetUpdate extends Base
{
    ...
    {
        if (!\array_key_exists('CUSTOM_SECTION_ID', $this->fields) || 0 !== (int) $this->fields['CUSTOM_SECTION_ID']) {
            return;
        }
    ...
    protected function getPreparedCustomSectionData(array $data): CustomSection
    {
        return Assembler::constructCustomSection($data);
    }
    ...
    protected function updateCustomSectionPages(): void
    {
        ...
        if (null !== $this->customSectionId && $this->realCustomSectionId > 0) {
