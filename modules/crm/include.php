...
CJSCore::RegisterExt('crm_activity_planner', [
    'js' => ['/bitrix/js/crm/activity_planner.js', '/bitrix/js/crm/communication_search.js'],
    'css' => '/bitrix/js/crm/css/crm-activity-planner.css',
    'lang' => '/bitrix/modules/crm/lang/'.LANGUAGE_ID.'/install/js/activity_planner.php',
    'rel' => ['core', 'popup', 'date', 'fx', 'socnetlogdest'],
]);

CJSCore::RegisterExt('crm_recorder', [
    'js' => ['/bitrix/js/crm/recorder.js'],
    'css' => '/bitrix/js/crm/css/crm-recorder.css',
    'rel' => ['webrtc_adapter', 'recorder'],
]);

CJSCore::RegisterExt('crm_visit_tracker', [
    'js' => ['/bitrix/js/crm/visit.js'],
    'css' => ['/bitrix/js/crm/css/visit.css', '/bitrix/components/bitrix/crm.activity.visit/templates/.default/style.css', '/bitrix/components/bitrix/crm.card.show/templates/.default/style.css'],
    'lang' => '/bitrix/modules/crm/lang/'.LANGUAGE_ID.'/install/js/visit.php',
    'rel' => ['crm_recorder', 'ui.fonts.opensans'],
]);

CJSCore::RegisterExt('crm_form_loader', [
    'js' => ['/bitrix/js/crm/form_loader.js'],
]);

CJSCore::RegisterExt('crm_import_csv', [
...
if (IsModuleInstalled('socialnetwork')) {
    CJSCore::RegisterExt('crm_sonet_commentaux', [
        'js' => '/bitrix/js/crm/socialnetwork.js',
    ]);
}

Asset::getInstance()->addJsKernelInfo('crm', ['/bitrix/js/crm/crm.js']);
