...
$GLOBALS['AR_BLOG_PUBLISH_STATUS'] = [
...
$GLOBALS['AR_BLOG_RESERVED_NAMES'] = ['admin', 'users', 'group', 'rss', 'new', 'user', 'user_friends', 'search', 'user_settings', 'user_settings_edit', 'group_edit', 'blog_edit', 'category_edit', 'post_edit', 'draft', 'moderation', 'trackback', 'post', 'post_rss', 'rss', 'rss_all', 'index'];
$GLOBALS['AR_BLOG_POST_RESERVED_CODES'] = ['admin', 'users', 'index', 'group', 'blog', 'user', 'user_friends', 'search', 'user_settings', 'user_settings_edit', 'group_edit', 'blog_edit', 'category_edit', 'post_edit', 'draft', 'moderation', 'trackback', 'post', 'post_rss', 'rss', 'rss_all', 'new'];
