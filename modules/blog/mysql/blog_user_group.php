...
class blog_user_group extends CAllBlogUserGroup
{
    // ADD, UPDATE, DELETE
    ...
    public static function GetList($arOrder = ['ID' => 'DESC'], $arFilter = [], $arGroupBy = false, $arNavStartParams = false, $arSelectFields = [])
    {
        ...
        if (count($arSelectFields) <= 0) {
            $arSelectFields = ['ID', 'BLOG_ID', 'NAME'];
        }
        ...
        $arFields = [
            ...
            'USER2GROUP_ID' => ['FIELD' => 'U2UG.ID', 'TYPE' => 'int', 'FROM' => 'INNER JOIN b_blog_user2user_group U2UG ON (G.ID = U2UG.USER_GROUP_ID AND G.BLOG_ID = U2UG.BLOG_ID)'],
            'USER2GROUP_USER_ID' => ['FIELD' => 'U2UG.USER_ID', 'TYPE' => 'int', 'FROM' => 'INNER JOIN b_blog_user2user_group U2UG ON (G.ID = U2UG.USER_GROUP_ID AND G.BLOG_ID = U2UG.BLOG_ID)'],
        ];
        // <-- FIELDS
