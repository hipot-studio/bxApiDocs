...
class _CEventsSocialnetwork
{
	...
	/**
	 * Событие вызывается в методе изменения параметров рабочей группы до изменения, и может быть использовано для отмены изменения или переопределения
	 * некоторых полей.
	 *
	 *
	...
	/**
	 * Событие вызывается при инициализации модуля социальной сети после заполнения массива дополнительного функционала. Оно может быть использовано для
	 * изменения массива дополнительного функционала.
	 *
	 *
	...
	/**
	 * Событие вызывается в методе изменения параметров дополнительного функционала до изменения, и может быть использовано для отмены изменения или
	 * переопределения некоторых полей.
	 *
	 *
	 * @param int $IDarray идентификатор группы
	 *
	...
	/**
	 * Событие вызывается в методе изменения параметров права на доступ к дополнительному функционалу до изменения, и может быть использовано для отмены
	 * изменения или переопределения некоторых полей.
	 *
	 *
	 * @param int $IDarray идентификатор группы
	 *
	...
	/**
	 * Событие вызывается в методе создания новой записи дополнительного функционала до вставки, и может быть использовано для отмены вставки или
	 * переопределения некоторых полей.
	 *
	 *
	...
	/**
	 * Событие вызывается в методе создания записи права на дополнительный функционал до вставки, и может быть использовано для отмены вставки или
	 * переопределения некоторых полей.
	 *
	 *
	 * @param array &$arParams Массив полей новой записи.
	...
	/**
	 * Событие вызывается в методе изменения параметров сообщения до изменения, и может быть использовано для отмены изменения или переопределения некоторых
	 * полей.
	 *
	 *
	 * @param int $IDarray идентификатор группы
	...
	/**
	 * Событие вызывается в методе создания связи между пользователем и рабочей группой до вставки, и может быть использовано для отмены вставки или
	 * переопределения некоторых полей.
	 *
	 *
	 * @param array &$arParams Массив полей новой записи.
	...
	/**
	 * Событие вызывается в методе изменения параметров связи между пользователем и рабочей группой до изменения, и может быть использовано для отмены
	 * изменения или переопределения некоторых полей.
	 *
	 *
	 * @param int $IDarray идентификатор группы
	...
	/**
	 * Событие вызывается в методе создания связи между пользователями до вставки, и может быть использовано для отмены вставки или переопределения некоторых
	 * полей.
	 *
	 *
	 * @param array &$arParams Массив полей новой записи.
	...
	/**
	 * Событие вызывается в методе изменения параметров связи между пользователями до изменения, и может быть использовано для отмены изменения или
	 * переопределения некоторых полей.
	 *
	 *
	 * @param int $IDarray идентификатор группы
	...
	/**
	 * при включенной поддержке ЧПУ компонента социальной сети в самом начале работы компонента. Позволяет подключить свои пути для ЧПУ в комплексном
	 * компоненте соцсети.
