...
use Bitrix\Disk\Internals\Engine\Binder;
        ...
        if ($isCompositeMode) {
            ...
            $APPLICATION->AddViewContent('below_pagetitle', '
				<script>
					...
					BX.message["disk_revision_api"] = '.(int) Configuration::getRevisionApi().';
					BX.message["disk_document_service"] = "'.(string) UserConfiguration::getDocumentServiceCode().'";
				</script>
			');
        } else {
            return [
                'lang_additional' => [
                    ...
                    'disk_revision_api' => (int) Configuration::getRevisionApi(),
                    'disk_document_service' => (string) UserConfiguration::getDocumentServiceCode(),
                ],
            ];
        }
    },
...
CJSCore::RegisterExt('file_dialog', [
