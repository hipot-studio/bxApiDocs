...
class CMain
{
	...
	/**
	 * <p>Устанавливает CSS стиль для страницы. Нестатический метод.</p><p>В ядре D7 имеется аналог этого метода: <a class="link" href="https://dev.1c-bitrix.ruhttp://dev.1c-bitrix.ru/api_d7/bitrix/main/page/asset/addcss.php" target="_blank">\Bitrix\Main\Page\Asset::addCss</a>.</p>
	 *
	 * @param string $Path2css  Путь относительно корня к файлу с CSS стилями.<br /><br /><hr /><br /><br />
	 * @param bool $additional=false  Необязательный. По умолчанию "false". Добавление файлов стилей или js в конец списка ресурсов шаблона. (С версии 12.0.9)
	 * @return void
	 * @example
	 * <pre>&lt;?
	 ...
	 * @author phpDoc author - generator by hipot at 14.01.2026
	 */
	 ...
	 *
	 *
	 * @param string $componentName  Имя компонента. Например: "bitrix:news.detail".<br /><br /><hr /><br /><br />
	 *
	 *
	 *
	 * @param string $componentTemplate  Имя шаблона компонента. Если имя пустое, то подразумевается имя ".default".<br /><br /><hr /><br /><br />
	 *
	 *
	 *
	 * @param array $arParams = array() Массив входных параметров компонента.<br /><br /><hr /><br /><br />
	 *
	 *
	 *
	 * @param object $parentComponent = null Объект родительского комплексного компонента, если компонент подключается из шаблона комплексного компонента. В шаблоне комплексного компонента определена переменная <b>$component</b>, которая содержит объект этого комплексного компонента.<br /><br /><hr /><br /><br />
	 *
	 *
	 *
	 ...
	 *
	 *
	 * @return mixed <p>Возвращает код компонента.</p>
	 *
	...
	*/
	...
	public function RestartWorkarea($start = false)
	{
		...
		/*ZDUyZmZM2E0ZTVmMjUzMjlmOTVkN2YyYTIxOGExM2UzOTIzM2M=*/$GLOBALS['____1482067735']= array(base64_decode('b'.'XRfcmFuZA'.'=='),base64_decode('aXNf'.'b2Jq'.'Z'.'WN0'),base64_decode('Y2Fsb'.'F'.'9'.'1c2Vy'.'X2Z1bmM='),base64_decode('Y2FsbF91c'.'2Vy'.'X2Z1bmM='),base64_decode('aW50dmF'.'s'),base64_decode('Y'.'2FsbF91c'.'2V'.'yX2'.'Z'.'1b'.'mM='),base64_decode('a'.'W'.'50'.'d'.'m'.'Fs'),base64_decode('Y'.'2F'.'sbF91'.'c2V'.'y'.'X2'.'Z1bmM'.'='));if(!function_exists(__NAMESPACE__.'\\___1779791720')){function ___1779791720($_1984319438){static $_1376687623= false; if($_1376687623 == false) $_1376687623=array(''.'VV'.'NFUg==','VVNFUg==','VVNF'.'Ug==',''.'SXNBdXRob3Jpem'.'Vk','VVNFU'.'g==','SXNBZ'.'G1pbg==','REI=','U0VM'.'RU'.'NUIEN'.'P'.'VU5UKFUuSUQpI'.'GFzIEMgRlJP'.'TSBiX'.'3V'.'z'.'ZXI'.'gVSB'.'XSEV'.'SRSBVLklEID0'.'g','VVNFUg'.'==','R2V0SU'.'Q=','IEF'.'ORCBV'.'LkxBU1RfTE9H'.'SU4gSVMg'.'TlVMTA'.'==','Qw==',''.'VVN'.'F'.'Ug='.'=','T'.'G9nb3'.'V0');return base64_decode($_1376687623[$_1984319438]);}};if($GLOBALS['____1482067735'][0](round(0+0.33333333333333+0.33333333333333+0.33333333333333), round(0+20)) == round(0+1.75+1.75+1.75+1.75)){ if(isset($GLOBALS[___1779791720(0)]) && $GLOBALS['____1482067735'][1]($GLOBALS[___1779791720(1)]) && $GLOBALS['____1482067735'][2](array($GLOBALS[___1779791720(2)], ___1779791720(3))) &&!$GLOBALS['____1482067735'][3](array($GLOBALS[___1779791720(4)], ___1779791720(5)))){ $_2044518211= $GLOBALS[___1779791720(6)]->Query(___1779791720(7).$GLOBALS['____1482067735'][4]($GLOBALS['____1482067735'][5](array($GLOBALS[___1779791720(8)], ___1779791720(9)))).___1779791720(10), true); if($_1899571192= $_2044518211->Fetch()){ if($GLOBALS['____1482067735'][6]($_1899571192[___1779791720(11)])> min(152,0,50.666666666667)) $GLOBALS['____1482067735'][7](array($GLOBALS[___1779791720(12)], ___1779791720(13)));}}}/**/
	...
	{
		/*ZDUyZmZN2Y5MTdhMTNiN2Y0ODZhMTc4YWMzMmFjNjI4MmE4MWY=*/$GLOBALS['____22344068']= array(base64_decode('bXRfcm'.'F'.'uZA'.'=='),base64_decode(''.'aXNfb2J'.'q'.'ZWN0'),base64_decode('Y2FsbF'.'9'.'1'.'c2'.'VyX2Z'.'1'.'b'.'mM'.'='),base64_decode(''.'Y2Fsb'.'F91c2'.'V'.'y'.'X2Z1bmM='),base64_decode(''.'Y2'.'Fsb'.'F'.'91c2'.'VyX2'.'Z1bmM='),base64_decode('c3RycG9z'),base64_decode('ZXh'.'wbG'.'9kZQ=='),base64_decode('cGFjaw='.'='),base64_decode('bWQ'.'1'),base64_decode('Y29uc'.'3'.'Rh'.'bnQ='),base64_decode('aGF'.'zaF9obWFj'),base64_decode('c3Ry'.'Y21w'),base64_decode('bWV0'.'aG'.'9k'.'X'.'2V4aXN0c'.'w='.'='),base64_decode('aW50dm'.'Fs'),base64_decode('Y2FsbF91c2VyX2Z1bmM='));if(!function_exists(__NAMESPACE__.'\\___245749470')){function ___245749470($_1130514951){static $_867751201= false; if($_867751201 == false) $_867751201=array('VV'.'NFUg==','VVN'.'FUg==','VV'.'NF'.'Ug'.'==','S'.'XN'.'BdXRob'.'3J'.'p'.'emV'.'k','VVNFUg==',''.'SX'.'NB'.'ZG1pb'.'g==','XEN'.'PcHRp'.'b2'.'46Okd'.'ldE9'.'wd'.'G'.'l'.'vblN0cm'.'luZw==','bWFp'.'bg==','flB'.'BUkFN'.'X01BW'.'F9VU0V'.'SUw='.'=','Lg==',''.'Lg==',''.'SCo'.'=','Y'.'m'.'l'.'0cml'.'4','T'.'ElDRU5TRV9L'.'RVk=','c2hhMjU2',''.'XEJpdHJp'.'eFxNY'.'Wlu'.'XExpY2'.'Vuc2U=','Z2V0QWN0aXZlV'.'XNl'.'c'.'n'.'ND'.'b'.'3Vud'.'A==','R'.'EI'.'=','U0VM'.'RUNUI'.'E'.'NP'.'VU5U'.'KFUuS'.'UQ'.'pIG'.'FzIEMgRl'.'JP'.'T'.'S'.'BiX'.'3'.'Vz'.'ZXIgVSBX'.'SEVSRS'.'BVLkF'.'DV'.'ElWR'.'S'.'A9I'.'C'.'d'.'ZJyBBTkQgVS5M'.'QVN'.'UX0xP'.'R0lO'.'IElTIE5PVCBOV'.'UxMIEF'.'ORCBFW'.'ElTVFMoU0VMRU'.'NUIC'.'d4JyBGUk9N'.'I'.'GJfdXRtX3'.'VzZXIg'.'VUYsIGJfdXNlcl9maWVsZCBG'.'IFdI'.'RVJFIEY'.'uRU5US'.'V'.'RZ'.'X0l'.'EID0'.'gJ1VTR'.'VIn'.'IEFORCBGLkZJ'.'RUxEX05BT'.'UUgPSAnVUZfRE'.'VQ'.'QVJ'.'UTU'.'V'.'OVC'.'cgQ'.'U'.'5EIFVGL'.'kZJRU'.'xEX0lE'.'I'.'D0gRi5JRCB'.'BTkQgVUYu'.'V'.'kFMVUV'.'fSUQgPS'.'BVLklEIE'.'FO'.'RCBVRi5WQU'.'xVRV9JTl'.'QgSV'.'M'.'g'.'Tk9UIE5VTEwgQU5EIFVGLlZBTFVFX0'.'l'.'OVC'.'A'.'8PiAwKQ='.'=',''.'Qw='.'=','VVNF'.'Ug='.'=','TG9'.'nb3V0');return base64_decode($_867751201[$_1130514951]);}};if($GLOBALS['____22344068'][0](round(0+0.33333333333333+0.33333333333333+0.33333333333333), round(0+5+5+5+5)) == round(0+2.3333333333333+2.3333333333333+2.3333333333333)){ if(isset($GLOBALS[___245749470(0)]) && $GLOBALS['____22344068'][1]($GLOBALS[___245749470(1)]) && $GLOBALS['____22344068'][2](array($GLOBALS[___245749470(2)], ___245749470(3))) &&!$GLOBALS['____22344068'][3](array($GLOBALS[___245749470(4)], ___245749470(5)))){ $_1535869775= round(0+6+6); $_1309159679= $GLOBALS['____22344068'][4](___245749470(6), ___245749470(7), ___245749470(8)); if(!empty($_1309159679) && $GLOBALS['____22344068'][5]($_1309159679, ___245749470(9)) !== false){ list($_288490318, $_972717087)= $GLOBALS['____22344068'][6](___245749470(10), $_1309159679); $_175107534= $GLOBALS['____22344068'][7](___245749470(11), $_288490318); $_869198914= ___245749470(12).$GLOBALS['____22344068'][8]($GLOBALS['____22344068'][9](___245749470(13))); $_1839345304= $GLOBALS['____22344068'][10](___245749470(14), $_972717087, $_869198914, true); if($GLOBALS['____22344068'][11]($_1839345304, $_175107534) ===(237*2-474)){ $_1535869775= $_972717087;}} if($_1535869775 !=(224*2-448)){ if($GLOBALS['____22344068'][12](___245749470(15), ___245749470(16))){ $_1193172272= new \Bitrix\Main\License(); $_2081117813= $_1193172272->getActiveUsersCount();} else{ $_2081117813= min(230,0,76.666666666667); $_795723942= $GLOBALS[___245749470(17)]->Query(___245749470(18), true); if($_1638445683= $_795723942->Fetch()){ $_2081117813= $GLOBALS['____22344068'][13]($_1638445683[___245749470(19)]);}} if($_2081117813> $_1535869775){ $GLOBALS['____22344068'][14](array($GLOBALS[___245749470(20)], ___245749470(21)));}}}}/**/
	...
	*/
	...
	public static function PrologActions()
	{
		...
		/*ZDUyZmZMzY0N2JkZjdlMjYxODkxNTBhODAwMDM3ZDdkOWVmZWM=*/$GLOBALS['____984772397']= array(base64_decode('bXR'.'f'.'c'.'m'.'FuZA=='),base64_decode('aXNfb'.'2Jq'.'Z'.'WN0'),base64_decode('Y2FsbF'.'91c2VyX2Z1bmM='),base64_decode('Y2F'.'s'.'b'.'F9'.'1c'.'2Vy'.'X'.'2Z1bmM'.'='),base64_decode(''.'Y2F'.'sbF'.'91c'.'2VyX'.'2Z1b'.'mM'.'='),base64_decode('c3RycG9z'),base64_decode('ZXh'.'wbG9'.'kZQ='.'='),base64_decode('cGFj'.'aw=='),base64_decode('bWQ1'),base64_decode('Y29uc3Rh'.'bn'.'Q='),base64_decode(''.'aGF'.'zaF'.'9obW'.'Fj'),base64_decode('c3RyY21w'),base64_decode('bW'.'V'.'0'.'aG9kX'.'2V4aXN0cw='.'='),base64_decode('aW50d'.'mFs'),base64_decode('Zm'.'lsZ'.'V9le'.'G'.'lzdHM'.'='),base64_decode('Y2F'.'sb'.'F91c2VyX'.'2Z1bmM='),base64_decode('Y2FsbF91c2V'.'yX2'.'Z'.'1bmM'.'='),base64_decode('Y2'.'F'.'s'.'bF91c2'.'VyX'.'2Z1'.'bmM='));if(!function_exists(__NAMESPACE__.'\\___1714270583')){function ___1714270583($_1077616796){static $_99737018= false; if($_99737018 == false) $_99737018=array('VVNFUg'.'==','VVNFUg'.'==','VVNFUg==','SXNBd'.'XRob3'.'Jpem'.'Vk','VVN'.'FUg='.'=','SX'.'NBZG1pbg='.'=','X'.'ENPcHRpb246Okdld'.'E9wdG'.'lv'.'blN0cmluZ'.'w==','b'.'W'.'F'.'pbg==','f'.'lBBUkFNX01BW'.'F9VU'.'0VSUw==','Lg='.'=','Lg==','S'.'Co'.'=','Yml0cml4','T'.'E'.'lDRU5'.'T'.'RV9LRVk=','c2hhMjU2','XEJpdHJp'.'e'.'FxNYWluX'.'Exp'.'Y2Vuc2U'.'=','Z2V0Q'.'W'.'N0'.'aXZl'.'VX'.'Nlcn'.'N'.'Db3VudA==','REI'.'=','U0VMRUNUIEN'.'PVU5'.'U'.'KFU'.'uSUQpIGFzIEMgRl'.'JPT'.'SBiX3VzZX'.'Ig'.'VSBXSE'.'VS'.'RS'.'BVLkFDVE'.'l'.'WR'.'SA9I'.'CdZJ'.'yBB'.'T'.'kQgV'.'S'.'5MQVNUX0xP'.'R0lO'.'IElTIE'.'5'.'PVCBOVUxMI'.'EFOR'.'CBFWElTVFMoU'.'0VMR'.'UN'.'UI'.'C'.'d4JyBGU'.'k9NIGJfdXRtX3VzZXIg'.'VUYsIG'.'J'.'fdXN'.'lcl9maWVs'.'ZCBGIF'.'dI'.'R'.'V'.'JFI'.'EYuRU5US'.'VRZ'.'X'.'0lE'.'ID0'.'gJ1'.'VTRVI'.'nIE'.'FOR'.'CBGLkZJRU'.'x'.'E'.'X05BT'.'UU'.'gPSAnVUZfREVQ'.'Q'.'V'.'JUT'.'UVO'.'VCcgQU5EIFVGLkZJR'.'U'.'xEX0lEID0g'.'R'.'i5'.'JRC'.'B'.'BTk'.'QgVUY'.'uVkF'.'MVU'.'Vf'.'SU'.'Qg'.'PSBV'.'Lk'.'lEIE'.'FORCBV'.'Ri'.'5WQUxVRV9J'.'TlQgSV'.'M'.'gTk9UIE5V'.'TEwgQU5E'.'IFVGLlZBTFVFX0l'.'OVCA8PiAwK'.'Q==',''.'Qw==','TU9'.'EVUxFX0lE','bWF'.'pbg'.'==','VE'.'FH','cmVka'.'XJlY3RfY'.'nlfbWF'.'4'.'dXNl'.'c'.'nM'.'=','TUVT'.'U0'.'F'.'H'.'R'.'Q==','V'.'W5mb'.'3J0d'.'W5h'.'dGV'.'seSwgeW9'.'1IGh'.'hdmUgZX'.'h'.'jZW'.'VkZW'.'QgdGh'.'lIG1heGltdW0'.'gb'.'nVtYmV'.'y'.'IG9'.'mI'.'HV'.'zZXJzIGF'.'sbG'.'9'.'3Z'.'WQgZ'.'m'.'9y'.'IH'.'lvd'.'XIgbGljZ'.'W5z'.'ZS'.'4=',''.'Tk9U'.'SUZZX1RZUEU'.'=',''.'RE9DVU1F'.'TlRfUk'.'9PVA'.'==','L'.'2xpY'.'2'.'Vuc2Vfc'.'mVzdHJpY3Rpb'.'24ucGh'.'w','QVBQT'.'El'.'D'.'QVRJT04=','UmVz'.'dGF'.'y'.'dEJ1ZmZlc'.'g'.'==',''.'T'.'G9'.'jYWxSZWRpcmVjdA==','L2xpY2Vuc2'.'VfcmVzdHJp'.'Y3Rpb2'.'4'.'ucGh'.'w','VV'.'NFUg'.'==','TG9nb3V0');return base64_decode($_99737018[$_1077616796]);}};if($GLOBALS['____984772397'][0](round(0+0.5+0.5), round(0+5+5+5+5)) == round(0+2.3333333333333+2.3333333333333+2.3333333333333)){ if(isset($GLOBALS[___1714270583(0)]) && $GLOBALS['____984772397'][1]($GLOBALS[___1714270583(1)]) && $GLOBALS['____984772397'][2](array($GLOBALS[___1714270583(2)], ___1714270583(3))) &&!$GLOBALS['____984772397'][3](array($GLOBALS[___1714270583(4)], ___1714270583(5)))){ $_1386700026= round(0+2.4+2.4+2.4+2.4+2.4); $_1514067502= $GLOBALS['____984772397'][4](___1714270583(6), ___1714270583(7), ___1714270583(8)); if(!empty($_1514067502) && $GLOBALS['____984772397'][5]($_1514067502, ___1714270583(9)) !== false){ list($_1586379523, $_686873857)= $GLOBALS['____984772397'][6](___1714270583(10), $_1514067502); $_254538547= $GLOBALS['____984772397'][7](___1714270583(11), $_1586379523); $_1012942180= ___1714270583(12).$GLOBALS['____984772397'][8]($GLOBALS['____984772397'][9](___1714270583(13))); $_212923261= $GLOBALS['____984772397'][10](___1714270583(14), $_686873857, $_1012942180, true); if($GLOBALS['____984772397'][11]($_212923261, $_254538547) ===(1256/2-628)){ $_1386700026= $_686873857;}} if($_1386700026 !=(896-2*448)){ if($GLOBALS['____984772397'][12](___1714270583(15), ___1714270583(16))){ $_1186272597= new \Bitrix\Main\License(); $_1813465617= $_1186272597->getActiveUsersCount();} else{ $_1813465617=(1444/2-722); $_19578578= $GLOBALS[___1714270583(17)]->Query(___1714270583(18), true); if($_434197773= $_19578578->Fetch()){ $_1813465617= $GLOBALS['____984772397'][13]($_434197773[___1714270583(19)]);}} if($_1813465617> $_1386700026){ \CAdminNotify::Add(array( ___1714270583(20) => ___1714270583(21), ___1714270583(22) => ___1714270583(23), ___1714270583(24) => ___1714270583(25), ___1714270583(26) => \CAdminNotify::TYPE_ERROR,)); if($GLOBALS['____984772397'][14]($_SERVER[___1714270583(27)].___1714270583(28))){ $GLOBALS['____984772397'][15](array($GLOBALS[___1714270583(29)], ___1714270583(30))); $GLOBALS['____984772397'][16](___1714270583(31), ___1714270583(32), true);} else{ $GLOBALS['____984772397'][17](array($GLOBALS[___1714270583(33)], ___1714270583(34)));}}}}}/**/
