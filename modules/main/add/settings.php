 ...
 * @param $arOptions CControllerClient::GetInstalledOptions($module_id);
 ...
 *
 *  Как разместить текстовый блок в желтом блоке (заметка), используется специальный ID опции "note":
 *  ['note' => Loc::getMessage('SITE_TAB_OPTION_NOTE')]
 * @see https://dev.1c-bitrix.ru/community/webdev/user/203730/blog/13249/
 */
