 ...
 * @static
 *
 * @see http://dev.1c-bitrix.ru/api_help/currency/functions/currencyformat.php
 *
 * @author Bitrix
 *
 ...
 * @static
 *
 * @see http://dev.1c-bitrix.ru/api_help/currency/functions/currencyformatnumber.php
 *
 * @author Bitrix
 *
 * @deprecated deprecated since currency 14.0.0  ->  CCurrencyLang::CurrencyFormat()
