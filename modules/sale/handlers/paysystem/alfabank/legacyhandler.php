...
Localization\Loc::loadMessages(__DIR__ . '/../sberbankonline/handler.php');

/**
 * Class AlfabankLegacyHandler
 * @package Sale\Handlers\PaySystem
 */
class AlfabankLegacyHandler extends PaySystem\ServiceHandler implements PaySystem\IRefund
{
