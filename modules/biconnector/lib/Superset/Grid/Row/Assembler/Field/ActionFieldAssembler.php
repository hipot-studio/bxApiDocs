...
class ActionFieldAssembler extends FieldAssembler
{
    protected function prepareColumn($value): string
    {
        ...
        if (
            (
                SupersetDashboardTable::DASHBOARD_TYPE_SYSTEM === $value['TYPE']
                || SupersetDashboardTable::DASHBOARD_TYPE_MARKET === $value['TYPE']
            )
        ...
        if (
            SupersetDashboardTable::DASHBOARD_TYPE_CUSTOM === $value['TYPE']
