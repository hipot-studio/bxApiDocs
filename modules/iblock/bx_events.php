...
{
	/**
	 * Событие вызывается в методе <a href="http://dev.1c-bitrix.ru/api_help/iblock/classes/ciblock/add.php">CIBlock::Add</a> до вставки информационного блока,
	...
	/**
	 * Событие "OnAfterIBlockAdd" вызывается после попытки добавления нового информационного блока методом <a
	 * href="http://dev.1c-bitrix.ru/api_help/iblock/classes/ciblock/add.php">CIBlock::Add</a>.
	 *
	 *
	...
	/**
	 * Событие вызывается в методе <a href="http://dev.1c-bitrix.ru/api_help/iblock/classes/ciblock/update.php">CIBlock::Update</a> до изменения
	 * информационного блока, и может быть использовано для отмены изменения или переопределения некоторых полей.
	 *
	 *
	...
	/**
	 * Событие "OnAfterIBlockUpdate" вызывается после попытки изменения информационного блока методом <a
	 * href="http://dev.1c-bitrix.ru/api_help/iblock/classes/ciblock/update.php">CIBlock::Update</a>.
	 *
	 *
	...
	/**
	 * Событие вызывается в методе <a href="http://dev.1c-bitrix.ru/api_help/iblock/classes/ciblockproperty/add.php">CIBlockProperty::Add</a> до вставки
	 * свойства в инфоблок, и может быть использовано для отмены вставки или переопределения некоторых полей.
	 *
	 *
	...
	/**
	 * Событие "OnAfterIBlockPropertyAdd" вызывается после попытки добавления нового свойства информационного блока методом <a
	 * href="http://dev.1c-bitrix.ru/api_help/iblock/classes/ciblockproperty/add.php">CIBlockProperty::Add</a>.
	 *
	 *
	...
	/**
	 * Событие вызывается в методе <a href="http://dev.1c-bitrix.ru/api_help/iblock/classes/ciblockproperty/update.php">CIBlockProperty::Update</a> до
	 * изменения свойства информационного блока, и может быть использовано для отмены изменения или для переопределения некоторых полей.
	 *
	 *
	...
	/**
	 * Событие "OnAfterIBlockPropertyUpdate" вызывается после попытки изменения свойства информационного блока методом <a
	 * href="http://dev.1c-bitrix.ru/api_help/iblock/classes/ciblockproperty/update.php">CIBlockProperty::Update</a>.
	 *
	 *
	...
	/**
	 * Событие "OnBeforeIBlockPropertyDelete" вызывается перед удалением свойства методом <a
	 * href="http://dev.1c-bitrix.ru/api_help/iblock/classes/ciblockproperty/delete.php">CIBlockProperty::Delete</a>. Как правило задачи обработчика данного
	 * события - разрешить или запретить удаление.
	 *
	 *
	...
	/**
	 * <p>Событие вызывается при построении списка <a href="http://dev.1c-bitrix.ru/api_help/iblock/classes/user_properties/index.php">пользовательских
	 * свойств</a>. Обработчик этого события должен вернуть массив описывающий пользовательское свойство. Содержимое этого массива описано в методе <a
	 * href="http://dev.1c-bitrix.ru/api_help/iblock/classes/user_properties/GetUserTypeDescription.php">GetUserTypeDescription</a>.    <br></p>
	 *
	 *
	...
	/**
	 * Событие вызывается в методе <a href="http://dev.1c-bitrix.ru/api_help/iblock/classes/ciblocksection/add.php">CIBlockSection::Add</a> до вставки
	 * информационного блока, и может быть использовано для отмены вставки или переопределения некоторых полей.
	 *
	 *
	...
	/**
	 * Событие "OnAfterIBlockSectionAdd" вызывается после попытки добавления нового раздела информационного блока методом <a
	 * href="http://dev.1c-bitrix.ru/api_help/iblock/classes/ciblocksection/add.php">CIBlockSection::Add</a>.
	 *
	 *
	...
	/**
	 * Событие вызывается в методе <a href="http://dev.1c-bitrix.ru/api_help/iblock/classes/ciblocksection/update.php">CIBlockSection::Update</a> до изменения
	 * раздела информационного блока, и может быть использовано для отмены изменения или для переопределения некоторых полей.
	 *
	 *
	...
	/**
	 * Событие "OnAfterIBlockSectionUpdate" вызывается после попытки изменения раздела информационного блока методом <a
	 * href="http://dev.1c-bitrix.ru/api_help/iblock/classes/ciblocksection/update.php">CIBlockSection::Update</a>.
	 *
	 *
	...
	/**
	 * Событие "OnBeforeIBlockSectionDelete" вызывается перед удалением раздела методом <a
	 * href="http://dev.1c-bitrix.ru/api_help/iblock/classes/ciblocksection/delete.php">CIBlockSection::Delete</a>. Как правило задачи обработчика данного
	 * события - разрешить или запретить удаление.
	 *
	 *
	...
	/**
	 * Событие вызывается в методе <a href="http://dev.1c-bitrix.ru/api_help/iblock/classes/ciblockelement/add.php">CIBlockElement::Add</a> до вставки элемента
	 * информационного блока, и может быть использовано для отмены вставки или переопределения некоторых полей.
	 *
	 *
	 ...
	 * }
	 * ?&gt;
	 * //пример обработчика, который при сохранении элемента переводит в транслит его заголовок, добавляет к заголовку текущую дату (для уникальности) и
	 *     передает в поле "Символьный код"
	 *
	 * // файл /bitrix/php_interface/init.php
	 * / регистрируем обработчик
	...
	/**
	 * <p>Событие вызывается в методе <a href="http://dev.1c-bitrix.ru/api_help/iblock/classes/ciblockelement/add.php">CIBlockElement::Add</a> до добавления
	 * элемента инфоблока перед проверкой правильности заполнения полей.</p>
	 *
	 *
	 * @param array &$arParams <a href="http://dev.1c-bitrix.ru/api_help/iblock/fields.php#felement">Массив полей</a> нового
	 * элемента информационного блока.
	...
	/**
	 * Событие "OnAfterIBlockElementAdd" вызывается после попытки добавления нового элемента информационного блока методом <a
	 * href="http://dev.1c-bitrix.ru/api_help/iblock/classes/ciblockelement/add.php">CIBlockElement::Add</a>.
	 *
	 *
	...
	/**
	 * Событие вызывается в методе <a href="http://dev.1c-bitrix.ru/api_help/iblock/classes/ciblockelement/update.php">CIBlockElement::Update</a> до изменения
	 * элемента информационного блока, и может быть использовано для отмены изменения или для переопределения некоторых полей.
	 *
	 *
	...
	/**
	 * <p>Событие вызывается в методе <a href="http://dev.1c-bitrix.ru/api_help/iblock/classes/ciblockelement/update.php">CIBlockElement::Update</a> до
	 * изменения элемента информационного блока перед проверкой правильности заполнения полей, и может быть использовано для переопределения некоторых
	 * полей.</p>
	 *
	 *
	 * @param array &$arParams <a href="http://dev.1c-bitrix.ru/api_help/iblock/fields.php#felement">Массив полей</a> изменяемого
	...
	/**
	 * Событие "OnAfterIBlockElementUpdate" вызывается после попытки изменения элемента информационного блока методом <a
	 * href="http://dev.1c-bitrix.ru/api_help/iblock/classes/ciblockelement/update.php">CIBlockElement::Update</a>.
	 *
	 *
	...
	/**
	 * Событие "OnBeforeIBlockElementDelete" вызывается перед удалением элемента методом <a
	 * href="http://dev.1c-bitrix.ru/api_help/iblock/classes/ciblockelement/delete.php">CIBlockElement::Delete</a>. Как правило задачи обработчика данного
	 * события - разрешить или запретить удаление.
	 *
	 *
	...
	/**
	 * <p>Вызывается в момент удаления элемента информационного блока.</p> <p></p> <div class="note"> <b>Примечание:</b> начиная с версии 15.5.12,  событие
	 * вызывается до удаления из таблиц любых данных, связанных с элементом.</div>
	 *
	 *
	...
	/**
	 * <p>Событие "OnAfterIBlockElementSetPropertyValues" вызывается после попытки сохранения значений всех свойств элемента инфоблока методом <a
	 * href="http://dev.1c-bitrix.ru/api_help/iblock/classes/ciblockelement/setpropertyvalues.php">CIBlockElement::SetPropertyValues</a>.</p>
	 *
	 *
	...
	/**
	 * <p>Событие "OnAfterIBlockElementSetPropertyValuesEx" вызывается после попытки сохранения значений свойств элемента инфоблока методом <a
	 * href="http://dev.1c-bitrix.ru/api_help/iblock/classes/ciblockelement/setpropertyvaluesex.php">CIBlockElement::SetPropertyValuesEx</a>.</p>
	 *
	 *
	 * @param int   $ELEMENT_ID Код элемента, значения свойств которого необходимо установить.
	 *
	...
	/**
	 * <p>Событие <i>OnIBlockElementAdd</i> вызывается в момент добавления элемента информационного блока.</p> <p>Событие вызывается в момент, когда уже
	 * отработали все обработчики, изменяющие данные, а также уже произошла проверка данных и идет запись в базу. Изменять данные событие не позволяет.
	 * Основной сценарий использования - выполнить некий код перед работой с базой, будучи уверенным, что данные в базе будут изменены. </p>
	 *
	 *
	...
	/**
	 * <p>Событие <i>OnIBlockElementUpdate</i> вызывается в момент изменения элемента информационного блока.</p> <p>Событие вызывается в момент, когда уже
	 * отработали все обработчики, изменяющие данные, а также уже произошла проверка данных и идет запись в базу. Изменять данные событие не позволяет.
	 * Основной сценарий использования - выполнить некий код перед работой с базой, будучи уверенным, что данные в базе будут изменены. </p>
	 *
	 *
	...
	/**
	 * <p>Событие <i>OnIBlockElementSetPropertyValues</i> вызывается в момент сохранения значений свойств элемента инфоблока.</p> <p>Событие вызывается в
	 * момент, когда уже отработали все обработчики, изменяющие данные, а также уже произошла проверка данных и идет запись в базу. Изменять данные событие не
	 * позволяет. Основной сценарий использования - выполнить некий код перед работой с базой, будучи уверенным, что данные в базе будут изменены. </p>
	 *
	 *
