...
class CIBlockSection extends CAllIBlockSection
{
	...
	/**
	 * <p>Возвращает список разделов, отсортированных в порядке<span class="syntax"><i> arOrder</i></span> по фильтру <i>arFilter</i>. Нестатический метод.</p><h4>Смотрите также</h4><ul> <li> <a class="link" href="http://dev.1c-bitrix.ru/api_help/iblock/classes/ciblockresult/index.php">CIBlockResult</a> </li> <li> <a class="link" href="http://dev.1c-bitrix.ru/api_help/iblock/fields.php#fsection">Поля раздела информационного блока </a> </li> </ul>
	 *
	 *
	 *
	 *
	 * @param array $arOrder = Array("SORT"=>"ASC") Массив для сортировки, имеющий вид <i>by1</i>=&gt;<i>order1</i>[, <i>by2</i>=&gt;<i>order2</i> [, ..]], где <i> by1, ... </i> - поле сортировки, может принимать значения: <ul> <li> <b>id</b> - код раздела;</li> <li> <b>section</b> - код родительской раздела;</li> <li> <b>name</b> - название раздела;</li> <li> <b>code</b> - символьный код раздела;</li> <li> <b>active</b> - активности раздела;</li> <li> <b>left_margin</b> - левая граница;</li> <li> <b>depth_level</b> - глубина вложенности (начинается с 1);</li> <li> <b>sort</b> - индекс сортировки;</li> <li> <b>created</b> - по времени создания раздела;</li> <li> <b>created_by</b> - по идентификатору создателя раздела;</li> <li> <b>modified_by</b> - по идентификатору пользователя изменившего раздел;</li> <li> <b>element_cnt</b> - количество элементов в разделе, работает только если <b>bIncCnt</b> = true;</li> <li> <b>timestamp_x</b> - по времени последнего изменения.</li> </ul> <i>order1, ... </i> - порядок сортировки, может принимать значения: <ul> <li> <b>asc</b> - по возрастанию;</li> <li> <b>desc</b> - по убыванию.</li> </ul> <br> Кроме того, сортировка возможна и по пользовательским свойствам UF_XXX. <br><br> Значение по умолчанию Array("SORT"=&gt;"ASC") означает, что результат выборки будет отсортирован по возрастанию. Если задать пустой массив Array(), то результат отсортирован не будет.<br /><br /><hr /><br /><br />
	 *
	 *
	 *
	 * @param array $arFilter = Array() Массив вида array("фильтруемое поле"=&gt;"значение" [, ...]). <i>Фильтруемое поле</i> может принимать значения: <ul> <li> <b>ACTIVE</b> - фильтр по активности (Y|N);</li> <li> <b>GLOBAL_ACTIVE</b> - фильтр по активности, учитывая активность вышележащих разделов (Y|N);</li> <li> <b>NAME</b> - по названию (можно искать по шаблону [%_]);</li> <li> <b>CODE</b> - по символьному коду (по шаблону [%_]);</li> <li> <b>XML_ID</b> или <b>EXTERNAL_ID</b> - по внешнему коду (по шаблону [%_]);</li> <li> <b>SECTION_ID</b> - по коду раздела-родителя (если указать false, то будут возвращены корневые разделы);</li> <li> <b>DEPTH_LEVEL</b> - по уровню вложенности (начинается с 1);</li> <li> <b>LEFT_BORDER</b>, <b> RIGHT_BORDER</b> - по левой и правой границе (используется, когда необходимо выбрать некий диапазон разделов, см. <a class="link" href="http://dev.1c-bitrix.ru#ex4">пример №4</a>);</li> <li> <b>LEFT_MARGIN</b>, <b>RIGHT_MARGIN</b> - по положению в дереве (используется, когда необходима выборка дерева подразделов, см. <a class="link" href="http://dev.1c-bitrix.ru#ex4">пример №4</a>);</li> <li> <b>ID</b> - по коду раздела;</li> <li> <b>IBLOCK_ID</b> - по коду родительского информационного блока. Обязателен, если нужно получить пользовательское свойство;</li> <li> <b>IBLOCK_ACTIVE</b> - по активности родительского информационного блока;</li> <li> <b>IBLOCK_NAME</b> - по названию информационного блока (по шаблону [%_]);</li> <li> <b>IBLOCK_TYPE</b> - по типу информационного блока (по шаблону [%_]);</li> <li> <b>IBLOCK_CODE </b><i> - </i>по символьному коду информационного блока (по шаблону [%_]);</li> <li> <b>IBLOCK_XML_ID</b> или <b>IBLOCK_EXTERNAL_ID</b> - по внешнему коду информационного блока (по шаблону [%_]);</li> <li> <span style="font-weight: bold; ">TIMESTAMP_X</span> - по времени последнего изменения;</li> <li> <span style="font-weight: bold; ">DATE_CREATE</span> - по времени создания;</li> <li> <span style="font-weight: bold; ">MODIFIED_BY </span>- по коду пользователя изменившему раздел; <br> </li> <li> <span style="font-weight: bold; ">CREATED_BY</span> - по содателю; <br> </li> <li> <span style="font-weight: bold; ">SOCNET_GROUP_ID</span> - по привязке к группе Социальной сети;</li> <li> <b>MIN_PERMISSION</b> - фильтр по правам доступа, по умолчанию принимает <i>R</i> (уровень доступа <i>Чтение</i>);</li> <li> <b>CHECK_PERMISSIONS</b> - если установлено значение "N", то проверки прав не происходит; </li> <li> <b>PERMISSIONS_BY</b> - фильтрация по правам произвольного пользователя. Значение - ID пользователя или 0 (неавторизованный).</li> <li> <b>PROPERTY </b><i> - </i>по значениям свойств внутрилежащих элементов, PROPERTY - массив вида Array("код свойства"=&gt;"значение", ...).</li> <li> <b>HAS_ELEMENT</b> - по наличию элемента. Используется в компоненте <b>catalog.detail</b>.</li> </ul> Все фильтруемые поля могут содержать перед названием <a class="link" href="http://dev.1c-bitrix.ruhttp://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=43&amp;LESSON_ID=2683" target="_blank">тип проверки фильтра</a>. <br> <br> <b><i>Значения фильтра</i></b> одиночное значение или массив. <br> <br> <div class="note"> <b>Важно!</b> Чтобы фильтрация выполнялась по пользовательским свойствам, необходимо обязательно передавать в фильтр <i>IBLOCK_ID</i>. Само свойство надо указывать в виде UF_... </div> <br> Необязательное. По умолчанию записи не фильтруются.<br /><br /><hr /><br /><br />
	 *
	 *
	 *
	 * @param bool $bIncCnt = false Возвращать ли поле <i>ELEMENT_CNT</i> - количество элементов в разделе. При этом arFilter дополнительно обрабатывает следующие фильтруемые поля:<b> <br> </b> <ul> <li> <b>ELEMENT_SUBSECTIONS</b> - подсчитывать элементы вложенных подразделов или нет (Y|N). По умолчанию Y;</li> <li> <b>CNT_ALL</b> - подсчитывать еще неопубликованные элементы (Y|N). По умолчанию N. Актуально при установленном модуле документооборота;</li> <li> <b>CNT_ACTIVE</b> - при подсчете учитывать активность элементов (Y|N). По умолчанию N. Учитывается флаг активности элемента ACTIVE и даты начала и окончания активности.</li> </ul> Необязательный параметр, по умолчанию равен false. <p><b>Примечание:</b> в случае если в фильтре есть ключ PROPERTY то в количестве элементов вернется то значение, которое попадает под этот фильтр по значению свойств.</p><br /><br /><hr /><br /><br />
	 *
	 *
	 *
	 * @param array $arSelect = Array() Массив для выборки. <ul> <li> <b>ID</b> - ID группы информационного блока.</li> <li> <b>CODE</b> - Символьный идентификатор.</li> <li> <b>EXTERNAL_ID или XML_ID</b> - Внешний код.</li> <li> <b>IBLOCK_ID</b> - ID информационного блока. </li> <li> <b>IBLOCK_SECTION_ID</b> - ID группы родителя, если не задан то группа корневая. </li> <li> <b>TIMESTAMP_X</b> - Дата последнего изменения параметров группы. </li> <li> <b>SORT</b> - Порядок сортировки (среди групп внутри одной группы-родителя).</li> <li> <b>NAME</b> - Наименование группы.</li> <li> <b>ACTIVE</b> - Флаг активности (Y|N)</li> <li> <b>GLOBAL_ACTIVE</b> - Флаг активности, учитывая активность вышележащих (родительских) групп (Y|N). Вычисляется автоматически (не может быть изменен вручную).</li> <li> <b>PICTURE</b> - Код картинки в таблице файлов.</li> <li> <b>DESCRIPTION</b> - Описание группы. </li> <li> <b>DESCRIPTION_TYPE</b> - Тип описания группы (text/html).</li> <li> <b>LEFT_MARGIN</b> - Левая граница группы. Вычисляется автоматически (не устанавливается вручную). </li> <li> <b>RIGHT_MARGIN</b> - Правая граница группы. Вычисляется автоматически (не устанавливается вручную). </li> <li> <b>DEPTH_LEVEL</b> - Уровень вложенности группы. Начинается с 1. Вычисляется автоматически (не устанавливается вручную). </li> <li> <b>SEARCHABLE_CONTENT</b> Содержимое для поиска при фильтрации групп. Вычисляется автоматически. Складывается из полей <b>NAME</b> и <b>DESCRIPTION</b> (без html тэгов, если <b>DESCRIPTION_TYPE</b> установлен в html).</li> <li> <b>SECTION_PAGE_URL</b> - Шаблон URL-а к странице для детального просмотра раздела. Определяется из параметров информационного блока. Изменяется автоматически.</li> <li> <b>MODIFIED_BY</b> - Код пользователя, в последний раз изменившего элемент.</li> <li> <b>DATE_CREATE</b> - Дата создания элемента.</li> <li> <b>CREATED_BY</b> - Код пользователя, создавшего элемент.</li> <li> <b>DETAIL_PICTURE</b> - Код картинки в таблице файлов для детального просмотра.</li> </ul> Кроме того, можно вывести пользовательские свойства, если задать их код (см. примечание ниже). (С версии 6.0.3)<br /><br /><hr /><br /><br />
	 *
	 *
	 *
	 * @param array|false $arNavStartParams = false Массив для постраничной навигации. Может содержать следующие ключи: <ul> <li> <b>bShowAll</b> - разрешить вывести все элементы при постраничной навигации;</li> <li> <b>iNumPage</b> - номер страницы при постраничной навигации;</li> <li> <b>nPageSize</b> - количество элементов на странице при постраничной навигации;</li> <li> <b>nTopCount</b> - ограничить количество возвращаемых методом записей сверху значением этого ключа (ключ доступен с версии <b>15.5.5 </b>).</li> </ul> Если в параметр передать пустой массив, то результат выборки будет ограничен десятью записями. А если передать значение <i>false</i> - то выборка будет полной. (С версии 11.0.0)
	 *
	 *
	 *
	 * @return CIBlockResult 
	 ...
	 * @author phpDoc author - generator by hipot at 15.02.2025
	 */
